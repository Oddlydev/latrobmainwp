	...
	<section id="top" class="scroll-mt-24">
		...
		<div class="relative overflow-hidden border border-gray-200 bg-white text-black shadow-[0_12px_40px_rgba(15,23,42,0.08)]">
			<img
				...
				alt=""
				aria-hidden="true"
				class="la-home-hero-image-desktop absolute inset-y-0 right-0 hidden h-full object-cover lg:block lg:w-[52%] lg:object-right xl:w-[60%] xl:[object-position:78%_center] 2xl:w-full"
			/>
			<div
				aria-hidden="true"
