	...
	<section id="top" class="scroll-mt-24">
		<div class="relative overflow-hidden border border-gray-200 bg-white text-black shadow-[0_12px_40px_rgba(15,23,42,0.08)]">
			<img
				...
				alt=""
				aria-hidden="true"
				class="absolute inset-y-0 right-0 hidden h-full w-[58%] bg-white object-contain object-right lg:block xl:w-[60%] 2xl:w-[62%]"
			/>
			...
			<div class="la-home-hero-image-mobile-shell relative overflow-hidden md:hidden">
				...
				<img
					src="<?php echo esc_url( get_field( 'home_hero_section_images' )['home_hero_section_images'][0]['home_hero_section_mobile_image'] ); ?>"
					alt=""
					aria-hidden="true"
			...
			<div class="la-home-hero-image-tablet-shell relative hidden overflow-hidden md:block lg:hidden">
				...
				<img
					src="<?php echo esc_url( get_field( 'home_hero_section_images' )['home_hero_section_images'][0]['home_hero_section_tablet_image'] ); ?>"
					alt=""
					aria-hidden="true"
	...
	<section class="la-how-it-works-section py-10 lg:py-20" style="--la-how-it-works-mobile-background-image:url('<?php echo esc_url( $how_it_works_background_images['home_how_it_works_section_mobile_background_image'] ?? '' ); ?>');--la-how-it-works-tablet-background-image:url('<?php echo esc_url( $how_it_works_background_images['home_how_it_works_section_tablet_background_image'] ?? '' ); ?>');--la-how-it-works-desktop-background-image:url('<?php echo esc_url( $how_it_works_background_images['home_how_it_works_section_desktop_background_image'] ?? '' ); ?>');">
		<div class="mx-auto w-full lg:max-w-[1295px]">
			...
			<div class="relative overflow-hidden" data-how-it-works data-how-marker-ratio="0.72">
				...
				<div class="relative z-10 mx-6 sm:mx-auto sm:max-w-[680px] lg:mx-auto lg:max-w-[904px] xl:max-w-[984px] 2xl:max-w-none">
					...
					<div class="space-y-10 py-5 lg:space-y-16 lg:py-0">
						...
						<?php foreach ( $how_it_works_items as $index => $step ) : ?>
							...
							?>
							<div class="la-how-step-row relative grid grid-cols-[auto_1fr] items-start gap-x-5 <?php echo $index === count( $how_it_works_items ) - 1 ? 'pb-5' : ''; ?> lg:mx-auto lg:w-fit lg:max-w-none lg:grid-cols-[380px_64px_380px] lg:items-center lg:gap-x-10 lg:gap-y-0 lg:pb-0 xl:grid-cols-[420px_64px_420px] xl:gap-x-12 2xl:grid-cols-[462px_64px_462px] 2xl:gap-x-14" data-how-it-works-step-row data-how-step-side="<?php echo $is_left ? 'left' : 'right'; ?>">
								...
								<article class="la-how-step-card col-start-2 row-start-1 min-w-0 w-full rounded-lg px-0 py-5 text-left transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform lg:py-4 <?php echo $is_left ? 'lg:col-start-1 lg:pl-0 lg:pr-6 lg:text-right xl:pr-8 2xl:pr-0' : 'lg:col-start-3 lg:pl-6 lg:pr-0 lg:text-left xl:pl-8 2xl:pl-0'; ?>">
