	...
	<section class="mx-auto w-full px-6 pt-10 sm:max-w-[680px] sm:px-0 md:pt-10 lg:max-w-[1295px] lg:pt-20">
		...
		<div class="grid gap-5 md:gap-7 lg:grid-cols-2 lg:gap-12">
			...
			<div class="overflow-hidden rounded-[1.25rem] border border-gray-300 bg-surface-card-soft shadow-none backdrop-blur-[2px]">
				<div class="grid grid-cols-[max-content_fit-content(165px)] items-center justify-between gap-5 px-5 py-6 md:grid-cols-[max-content_fit-content(300px)] md:gap-6 lg:grid-cols-[auto_minmax(0,1fr)] lg:gap-9 lg:px-8 lg:py-10"><p class="body-base-600 text-lg leading-7 tracking-tighter text-gray-600 uppercase">Project title</p><p class="body-base-400 justify-self-end text-right text-black md:text-xl md:leading-8 lg:w-full">PCAT for Aged Care</p></div>
				<div class="grid grid-cols-[max-content_fit-content(165px)] items-center justify-between gap-5 border-t border-gray-200 px-5 py-6 md:grid-cols-[max-content_fit-content(300px)] md:gap-6 lg:grid-cols-[auto_minmax(0,1fr)] lg:gap-9 lg:px-8 lg:py-10"><p class="body-base-600 text-lg leading-7 tracking-tighter text-gray-600 uppercase">Funding</p><p class="body-base-400 justify-self-end text-right text-black md:text-xl md:leading-8 lg:w-full">The Aged Care Research and Industry Innovation Australia fund (ARIIA)</p></div>
				<div class="grid grid-cols-[max-content_fit-content(165px)] items-center justify-between gap-5 border-t border-gray-200 px-5 py-6 md:grid-cols-[max-content_fit-content(300px)] md:gap-6 lg:grid-cols-[auto_minmax(0,1fr)] lg:gap-9 lg:px-8 lg:py-10"><p class="body-base-600 text-lg leading-7 tracking-tighter text-gray-600 uppercase">Institution</p><p class="body-base-400 justify-self-end text-right text-black md:text-xl md:leading-8 lg:w-full">La Trobe University</p></div>
			</div>
		</div>
	</section>
